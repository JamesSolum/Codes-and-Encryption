...
#' to itself n times. If n is zero, returns the point at infinity. If p is the point at infinity,
#' also returns the point at infinity. We call this operation "exponentiation", but since we
